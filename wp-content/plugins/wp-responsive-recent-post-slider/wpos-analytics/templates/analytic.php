...
<div class="wrap wpos-anylc-optin">
	...
	<form method="POST" action="https://analytics.wponlinesupport.com">
		<div class="wpos-anylc-optin-wrap" style="width: 600px; margin: 0 auto; margin-top: 70px;">
			<div style="background-color: #ff7b00;">
				<div style="height:50px; text-align: center;">
					<img style=" margin-top:-64px; border-radius:3%;" src="<?php echo esc_url( $analy_product['icon'] ); ?>" alt="Icon" />
				</div>
				<div style="padding: 10px; background-color: #ff7b00; text-align: center;">
					<div style="color: #FFF; font-weight: 400; font-size: 28px; margin-top:30px; margin-bottom: 30px; line-height: 28px;">Join Over 100,000 of your Peers!</div>
					<div style="color: #FFF; font-size:18px; line-height:18px; margin-bottom:15px;">Get Weekly Articles and WordPress News delivered to your email inbox.</div>
					<div style="color: #FFF; font-size:18px; line-height:18px; margin-bottom:10px;">Launch your WordPress website with premium tools and WordPress website growth insights.</div>
				</div>
			</div>
			...
			<!-- <div class="wpos-anylc-optin-cnt"> -->
				...
				<div>
					<p>Since we are Indians, We also share our knowledge on &#129496;<span class="wpos-anylc-line-style">Yoga</span> 🧉<span class="wpos-anylc-line-style">Ayurveda</span> & &#127807;<span class="wpos-anylc-line-style">Plant Based Eating</span>.</p>
			...
			<div class="wpos-anylc-optin-action wpos-anylc-clearfix" style="background-color: rgba(180,185,190, 0.3);">
				...
				<?php if( is_null( $opt_in ) ) { ?>
				<button type="submit" name="wpos_anylc_action" class="button button-secondary right button-large wpos-anylc-skip-btn" value="skip" style="padding: 0 !important;background: transparent;border: none;">Skip</button>
				<?php }
